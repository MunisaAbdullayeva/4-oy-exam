...
console.log(harflar[11].toUpperCase() + harflar[19] + harflar[12] + harflar[7] + harflar[17] + harflar[0])
...
let son = prompt('yoshingizni yozing');

if (son >= 18) {
    let yosh = +prompt("Siz balag'ot yoshiga yetgansiz");
    console.log(son)
} else if (son < 18) {
    let = prompt("balog'at yoshi muborak");
...
let odd = sonlar.filter(item => item % 2 === 0)

console.log("JUFT SONLAR: " + even)
console.log("JUFT SONLAR: " + odd)